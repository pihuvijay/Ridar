    ...
    >
      ...
      <View style={styles.cardInfo}>
        <View style={styles.infoLeft}>
          <View style={styles.infoChip}>
            <Text style={styles.infoChipText}>⏱ Leaving in {item.leavingIn} min</Text>
          </View>
          <View style={styles.infoChip}>
      ...
      <View style={styles.driverSection}>
        ...
        <View style={styles.driverInfo}>
          ...
          <Text style={styles.driverTrips}>{item.driverTrips} trips</Text>
        </View>
      </View>
    </Pressable>
  );
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.headerSection}>
        ...
        <View style={styles.headerNav}>
          <Pressable onPress={onViewSettings} style={styles.navButton}>
      ...
      <View style={styles.filterButtonsSection}>
        ...
        <View style={styles.filterButtonsContainer}>
          <Pressable
            style={[
              styles.filterButton,
              activeFilters.has('female-only') && styles.filterButtonActive,
            ]}
          ...
          <Pressable
            style={[
              styles.filterButton,
              activeFilters.has('alcohol-free') && styles.filterButtonActive,
            ]}
            onPress={() => toggleFilter('alcohol-free')}
          >
            <Text style={styles.filterButtonText}>Alcohol Free</Text>
          </Pressable>
          <Pressable
            style={[
              styles.filterButton,
              activeFilters.has('same-course') && styles.filterButtonActive,
            ]}
            onPress={() => toggleFilter('same-course')}
          >
            <Text style={styles.filterButtonText}>Same Course as Me</Text>
          </Pressable>
        </View>
      </View>

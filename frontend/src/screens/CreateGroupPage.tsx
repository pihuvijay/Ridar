...
export const CreateGroupPage = ({
  ...
  const handleCreateGroup = () => {
    console.log("Create Ride Group clicked", {
      pickupPoint,
      optionalStops,
      finalDestination,
      departureTime,
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputGroup}>
            <View style={styles.labelRow}>
              <Text style={styles.label}>Optional Stops Along the Way</Text>
              <TouchableOpacity>
                <Text style={styles.addStopButton}>+ Add Stop</Text>
              </TouchableOpacity>
            </View>
            <View style={styles.inputContainer}>
              <Text style={styles.inputIcon}>🛑</Text>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.preferenceItem}>
            <View style={styles.preferenceContent}>
              <Text style={styles.preferenceTitleText}>Allow custom stops</Text>
          ...
          <View style={styles.preferenceItem}>
            <View style={styles.preferenceContent}>
              <Text style={styles.preferenceTitleText}>Female only</Text>
              <Text style={styles.preferenceDescriptionText}>
          ...
          <View style={styles.preferenceItem}>
            <View style={styles.preferenceContent}>
              <Text style={styles.preferenceTitleText}>Alcohol free</Text>
              <Text style={styles.preferenceDescriptionText}>
        ...
        >
          <Text style={styles.createButtonText}>Create Ride Group</Text>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
  );

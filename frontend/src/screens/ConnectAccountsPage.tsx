...
export const ConnectAccountsPage = ({
	...
	const isPaymentComplete = uberConnected && cardholderName.trim().length > 0;
				...
				>
					...
					<View style={styles.paymentCard}>
						...
						<Text style={styles.paymentDescription}>
							Enter your card details securely. Your information
							will be sent to your backend and processed by
							Stripe.
						</Text>
					...
					<TouchableOpacity
						style={[
							...
							!isPaymentComplete && styles.continueButtonDisabled,
						]}

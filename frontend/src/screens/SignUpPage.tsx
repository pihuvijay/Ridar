...
interface SignUpPageProps {
	onSignIn?: () => void;
	onCreateAccount?: (fullName: string) => void;
}
...
export const SignUpPage = ({
	...
	const handleSendVerificationCode = async () => {
		if (!formData.email) {
			Alert.alert(
				"Missing Email",
				"Please enter your university email first",
			);
			return;
		}
	...
	const handleCreateAccount = async () => {
		...
		if (success) {
			...
			if (onCreateAccount) onCreateAccount(formData.fullName);
		} else if (signUpError) {
							...
							<View style={styles.emailSection}>
								...
								{!emailVerified && codeSent && (
									<Text style={styles.successText}>
										Verification code sent. Enter it above
										to continue.
									</Text>
								)}
								{emailVerified && (

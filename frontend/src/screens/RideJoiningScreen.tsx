    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          <Text style={styles.headerTitle}>{rideDetails.destination}</Text>
          <Text style={styles.headerSubtitle}>
            {rideDetails.ridersJoined}/{rideDetails.totalRiders} riders joined
          </Text>
        </View>
      ...
      <View style={styles.rideDetailsCard}>
        ...
        <View style={styles.detailRow}>
          ...
          <Text style={styles.priceText}>{rideDetails.pricePerPerson}</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>
          👥 Riders ({rideDetails.ridersJoined}/{rideDetails.totalRiders})
        </Text>
        <FlatList
          data={mockRiders}

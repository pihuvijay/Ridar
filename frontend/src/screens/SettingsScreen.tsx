    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingItemWithToggle}>
            <View style={styles.settingLeft}>
              <View style={[styles.settingIconContainer, { backgroundColor: COLORS.accentYellow }]}>
                <Text style={styles.settingIcon}>🔔</Text>
              </View>
              <View style={styles.settingContent}>
          ...
          <View style={styles.settingItemWithToggle}>
            <View style={styles.settingLeft}>
              ...
              <View style={styles.settingContent}>
                <Text style={styles.settingName}>Ride Reminders</Text>
                <Text style={styles.settingDescription}>Get notified before rides</Text>
              </View>
            </View>
            <Switch
              value={rideReminders}
          ...
          <View style={styles.settingItemWithToggle}>
            <View style={styles.settingLeft}>
              ...
              <View style={styles.settingContent}>
                <Text style={styles.settingName}>Chat Messages</Text>
                <Text style={styles.settingDescription}>New message alerts</Text>
              </View>
            </View>
            <Switch
              value={chatMessages}
        ...
        <View style={styles.section}>
          ...
          <Pressable style={styles.settingItem} onPress={() => {}}>
            <View style={styles.settingLeft}>
              <View style={[styles.settingIconContainer, { backgroundColor: '#E9D5FF' }]}>
                <Text style={styles.settingIcon}>🔒</Text>
              </View>
              <View style={styles.settingContent}>
        ...
        <View style={styles.section}>
          ...
          <Pressable style={styles.settingItem} onPress={() => {}}>
            <View style={styles.settingLeft}>
              ...
              <View style={styles.settingContent}>
                <Text style={styles.settingName}>About Ridar</Text>

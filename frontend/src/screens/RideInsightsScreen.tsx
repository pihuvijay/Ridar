      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.co2ContextCard}>
          ...
          <View style={styles.co2ContextContent}>
            <Text style={styles.co2ContextTitle}>Great choice sharing this ride!</Text>
            <Text style={styles.co2ContextText}>
              You and your party saved {(co2SavedKg * mockPartyRiders.length).toFixed(1)} kg of CO2
              combined versus driving separately.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.detailRow}>
            <Text style={styles.detailIcon}>👥</Text>
            <Text style={styles.detailText}>{mockPartyRiders.length} riders sharing</Text>
          </View>
        </View>

        {/* Party Members + Report */}
        <View style={styles.card}>
          ...
          <View style={styles.modalSheet}>
            {reportSubmitted ? (
              <View style={styles.reportSuccess}>
                ...
                <Pressable style={styles.closeButton} onPress={handleCloseReport}>
              ...
              <>
                ...
                {selectedRider && (
                  <View style={styles.reportingUserRow}>
                    <View style={styles.reportingAvatar}>
                      <Text style={styles.reportingAvatarText}>{selectedRider.initial}</Text>
                    </View>
                    <View>
                      <Text style={styles.reportingLabel}>Reporting</Text>
                      <Text style={styles.reportingName}>{selectedRider.name}</Text>
                    </View>
                  </View>
                )}
                ...
                <View style={styles.modalActions}>
                  <Pressable style={styles.cancelButton} onPress={handleCloseReport}>
